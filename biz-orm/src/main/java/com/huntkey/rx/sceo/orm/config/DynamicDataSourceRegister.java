...
//        }
    ...
    public void addDynamicDataSource(Environment env){
        ...
        try {
            ...
            String sql = "SELECT ente_sceo_url, ente_dbuser, ente_dbpassword, ente_dbaddress FROM ecodb.enterprise where is_del = '0'";
...
//            int columns = metaData.getColumnCount();
            ...
            while(resultSet.next())
            {
                ...
                if (!StringUtil.isNullOrEmpty(dbName)
                    ...
                    url = "jdbc:mysql://"+url+"/"+dbName+Constant.EDM+"?useSSL=false";
                    Map<String, Object> map = new HashMap<>();
                    map.put("dataSource", dbName+Constant.EDM);
