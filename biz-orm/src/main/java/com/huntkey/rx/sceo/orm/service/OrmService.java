...
public interface OrmService {
     ...
     *
     * @param t   更新的实体数据
     * @param columns   明确指定需要更新的属性列范围
     * @param <T>
     * @return 返回更新的记录数
     * @throws Exception
     */
    <T extends BaseEntity> int update(T t, Set<String> columns) throws Exception;
     ...
     * @throws Exception
     */
    <T extends BaseEntity> int updateSelective(T t, Set<String> columns) throws Exception;
     ...
     * @throws Exception
     */
    <T extends BaseEntity> List<Map<String, Object>> selectMapListEx(Class<T> entityClazz, OrmParamEx ormParam) throws Exception;
     ...
     * @throws Exception
     */
    <T extends BaseEntity> long countEx(Class<T> entityClazz, OrmParamEx ormParamEx) throws Exception;
     ...
     * @throws Exception
     */
    <T extends BaseEntity> Pagination<T> selectPagedMapListEx(Class<T> entityClazz, OrmParamEx ormParamEx) throws Exception;
