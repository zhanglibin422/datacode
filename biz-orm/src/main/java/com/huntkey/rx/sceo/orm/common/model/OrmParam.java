...
//    }
     ...
     * 列-值映射(插入或者更新的时候使用)
     */
    protected Map<String, Object> columnValueMapping;
     ...
     * group by 的列名
     */
    protected Set<String> groupColumnNames;

    /**
     * having 统计条件
     */
    protected String havingExp;
    /**
     * order by 表达式
     * <p>格式:columnName asc|desc</p>
     * <p>多个排序字段用逗号分隔</p>
     */
    protected String orderExp;
     ...
     */
    protected final static boolean isAggregateFunctionColumn(String fieldName) {
